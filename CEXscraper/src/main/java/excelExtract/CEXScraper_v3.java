...
public class CEXScraper_v3 {
     ...
     */
    public static List<Item> getCEXinfo(List<Item> itemList, String cexURL) {
        ...
        try {
            for (Item item : itemList) {
                try {
                    ...
                    Item result = scrapeItemInfo(driver,item,cexURL);
     ...
     */
    private static Item scrapeItemInfo(WebDriver driver, Item item, String cexURL) {
        try {
            String searchURL = composeProductURL(item.getWrtItemName(), cexURL);
     ...
     */
    private static String composeProductURL(String product, String cexURL) {
        return cexURL + product.replace(" ", "%20");
    }
}
